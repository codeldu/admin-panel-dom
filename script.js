...
function createCustomer(arr){
    ...
    body.innerHTML = arr.map((customerInfo)=> {
        return ` <tr>
                ...
                <td>${customerInfo.contactTitle}</td>
        ...
        editBtn.addEventListener('click', (e)=>{
            ...
            if (e.target.innerText == 'Edit') {
                ...
                siblings.forEach((el, i)=>{
                    if(i<4){
                        el.innerHTML = `<input type="text" value="${el.innerText}"> `
                    }
                })
                ...
                console.log(arr);
                arr[index]["id"] = siblings[0].children[0].value;
                arr[index].companyName = siblings[1].children[0].value;
                arr[index].contactName = siblings[2].children[0].value;
                arr[index].contactTitle = siblings[3].children[0].value;
...
sorter.addEventListener('change',(e)=>{
    if (e.target.value == 'a-to-z') {
        createCustomer(customers.toSorted((a,b)=> a.contactName.localeCompare(b.contactName)))
    }else if (e.target.value == 'z-to-a') {
        createCustomer(customers.toSorted((a,b)=> b.contactName.localeCompare(a.contactName)))
    }else{
...
addBtn.addEventListener('click', ()=>{
    ...
    <td><input type="text" id="inputCompanyName"></td>
    <td><input type="text" id="inputContactName"></td>
    <td><input type="text" id="inputContactTitle"></td>
    ...
    crtBtn.addEventListener('click', ()=>{
        let newOj = {
            ...
            companyName : document.querySelector('#inputCompanyName').value,
            contactName : document.querySelector('#inputContactName').value,
            contactTitle : document.querySelector('#inputContactTitle').value
        }

        customers.push(newOj);
...
//     td1.innerText = customerInfo.id;

//     let td2 = document.createElement('td')
//     td2.innerText = customerInfo.companyName;

//     let td3 = document.createElement('td')
//     td3.innerText = customerInfo.contactName;

//     let td4 = document.createElement('td')
//     td4.innerText = customerInfo.contactTitle;
